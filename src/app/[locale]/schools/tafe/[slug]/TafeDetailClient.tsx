...
export default function TafeDetailClient({ school }: { school: School }) {
    const tUni = useTranslations("uniDetails"); // Reusing general strings from uniDetails
        ...
        <main className="min-h-screen bg-sand-light/30">
            ...
            <div className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden flex items-end min-h-[50vh]">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                    ...
                    >
                        <Link href="/schools/tafe" className="inline-flex items-center gap-2 text-white/70 hover:text-white transition-colors mb-6 text-sm font-medium uppercase tracking-wider backdrop-blur-md bg-white/10 px-4 py-2 rounded-full border border-white/20">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="col-span-1 bg-white rounded-3xl p-6 sm:p-8 shadow-[0px_8px_24px_rgba(10,25,47,0.06)] border border-navy/5 flex flex-col justify-center">
                        ...
                        <p className="text-xl sm:text-3xl font-extrabold text-navy flex-1">
                            ${school.price || "N/A"}+ <span className="text-sm sm:text-lg font-medium text-navy/60">/ course</span>
                        </p>
                    </motion.div>
