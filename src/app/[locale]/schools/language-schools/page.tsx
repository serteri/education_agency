...
import { LanguageSchoolsClient } from "./LanguageSchoolsClient";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const t = await getTranslations({ locale, namespace: "lsMetadata" });
    return {
        title: t("title"),
...
export default async function LanguageSchoolsPage({ params }: Props) {
    const { locale } = await params;
    ...
    const t = await getTranslations({ locale, namespace: "schoolPages.languageSchools" });
